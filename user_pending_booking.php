...
$query = "SELECT * FROM jobs WHERE ordered_by = '$email' AND status = 'confirmed';";
$count = $db_handle->numRows($query);
$total_rows = $count;
$total_pages = ceil($total_rows / $no_of_records_per_page);

$query = "SELECT * FROM jobs WHERE ordered_by = '$email' AND status = 'confirmed' LIMIT $offset, $no_of_records_per_page";
$result = $db_handle->runQuery($query);
