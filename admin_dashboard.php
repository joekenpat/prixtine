...
$query = "SELECT job_id FROM jobs WHERE (status = 'confirmed' OR status ='completed')";
$count = $db_handle->numRows($query);
$total_jobs = $count;

//load total completed user created jobs counts
$query = "SELECT job_id FROM jobs WHERE status = 'completed'";
$count = $db_handle->numRows($query);
$completed_jobs = $count;

//load total completed user created jobs counts
$query = "SELECT job_id FROM jobs WHERE status = 'confirmed'";
$count = $db_handle->numRows($query);
$pending_jobs = $count;
